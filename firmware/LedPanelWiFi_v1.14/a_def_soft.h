...
#define EEPROM_OK     0xF7                       // Флаг, показывающий, что EEPROM инициализирована корректными данными 
...
#ifndef DEFAULT_IP
#define DEFAULT_IP {192, 168, 1, 152}            // Сетевой адрес устройства по умолчанию
#endif
...
String  effect_order = "13456789ABCDEFGHIJKLMNOPQUVWXYZabefgijk";
...
bool     specialClock = true;              // Отображение часов в спец.режиме - как отдельный эффект "Часы" на черном фоне, а не как оверлей поверх других эффектов
...
bool     clockOverlayEnabled = false;        // Доступность оверлея часов поверх эффектов
bool     textOverlayEnabled = false;         // Доступность оверлея бегущей строки поверх эффектов
...
bool       wasTurnedOff, touchEffectReady = true;
